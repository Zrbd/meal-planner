...
export const STORAGE: Record<string, StorageInfo> = {
  ...
  poblano: { tip: 'Store whole and dry in a paper bag in the crisper. Roasted, peeled poblanos freeze well in a flat bag.', days: { fridge: 14 } },
  cabbage: {
    tip: "Keep the head whole and unwashed — peel off outer leaves as you go rather than cutting. Once cut, wrap the cut face tightly in plastic; it still lasts a couple of weeks.",
    days: { fridge: 45 },
  },
  kale: {
    tip: 'Wrap unwashed leaves loosely in a paper towel inside a bag in the crisper. Kale about to turn? Strip the leaves, chop, and freeze — it goes straight into soups and smoothies.',
    days: { fridge: 10, freezer: 180 },
  },
  cauliflower: { tip: 'Store the head stem-side up in a loose bag so moisture doesn\'t collect on the florets. Trim brown spots off — the rest is fine.', days: { fridge: 14 } },
  leek: { tip: "Leave leeks untrimmed and unwashed, loosely wrapped in a damp paper towel in the crisper. Sliced and rinsed leeks freeze well for soups.", days: { fridge: 14 } },
  'bean-sprouts': {
    tip: 'Sprouts spoil fastest of all — use within 2 days. To stretch it, submerge them in cold water in a sealed container and change the water daily.',
    shelfLife: { fridge: 2 },
    days: { fridge: 4 },
  },
  'snow-peas': { tip: 'Keep dry in a perforated or partly open bag in the crisper.', days: { fridge: 7 } },
  'fresh-dill': { tip: `Wrap dill in a slightly damp paper towel and seal it in a bag — it wilts faster in a water jar than other herbs. Chopped dill freezes well.`, shelfLife: { fridge: 5 }, days: { fridge: 10 } },
  'fresh-thyme': { tip: 'Wrap the sprigs in a damp paper towel inside a zip-top bag. Whole sprigs freeze on the stem — strip the leaves straight from frozen.', days: { fridge: 14, freezer: 180 } },
  'fresh-rosemary': { tip: 'Wrap in a damp paper towel inside a bag. Rosemary also dries well hung upside down, or freeze sprigs in olive oil in an ice cube tray.', days: { fridge: 21, freezer: 180 } },
  'butternut-squash': { tip: 'Whole squash keeps for months somewhere cool and dark. Once cut, wrap the pieces and refrigerate; peeled cubes freeze well for roasting from frozen.', days: { pantry: 60 } },
  'corn-on-cob': { tip: "Corn loses sweetness fast — refrigerate in the husk and cook within a couple of days. To save it, cut the kernels off and freeze them in a bag.", shelfLife: { fridge: 3 }, days: { freezer: 240 } },
  eggplant: { tip: "Eggplant hates the cold. Keep it on the counter out of sun and use within a few days, or in the warmest part of the fridge wrapped in a towel.", days: { pantry: 5 } },
  mango: { tip: 'Ripen on the counter, then refrigerate once it gives slightly to buy about 5 extra days. Cubed mango freezes perfectly.', days: { fridge: 10, freezer: 180 } },
  arugula: {
    tip: "Tuck a dry paper towel into the box and keep it closed. Arugula is delicate — use it within a few days, and wilt any leftovers into pasta or eggs.",
    shelfLife: { fridge: 4 },
    days: { fridge: 7 },
  },
  radishes: { tip: 'Cut off the greens right away (they draw out moisture), then store the radishes in a container of water in the fridge.', days: { fridge: 21 } },
  ...
  'chicken-drumsticks': { tip: MEAT_FREEZE, days: { freezer: 270 }, thaw: MEAT_THAW },
  'pork-tenderloin': { tip: MEAT_FREEZE, days: { freezer: 180 }, thaw: MEAT_THAW },
  'ground-pork': { tip: MEAT_FREEZE, days: { freezer: 120 }, thaw: MEAT_THAW },
  'italian-sausage': { tip: MEAT_FREEZE, days: { freezer: 60 }, thaw: MEAT_THAW },
  'rotisserie-chicken': {
    tip: 'Pull the meat off the bones within a day (it\'s easiest while still warm), store it in a sealed container, and freeze anything you won\'t use in 3–4 days in 1-cup bags.',
    days: { freezer: 120 },
    thaw: 'Thaw overnight in the fridge, or add frozen shredded chicken straight into soups, enchiladas, and fried rice.',
  },
  cod: {
    tip: 'Keep it on ice or in the coldest part of the fridge and cook within 1–2 days, or freeze tightly wrapped.',
    days: { freezer: 120 },
    thaw: 'Thaw overnight in the fridge. Quick: keep it sealed and submerge in cold water for about 30–60 minutes. Thin fillets can be baked from frozen with a few extra minutes.',
  },
  ...
  'cheese-slices': { tip: 'Reseal the package tightly with the air pressed out. Slices freeze fine for grilled cheese and melts.', days: { freezer: 60 } },
  'goat-cheese': { tip: 'Once opened, wrap the log tightly in plastic. Goat cheese crumbles freeze well for cooking.', days: { freezer: 90 } },
  'half-and-half': { tip: 'Keep on a back shelf, not the door. Freeze extra in ice cube trays for coffee and sauces.', days: { freezer: 90 } },
  'cottage-cheese': { tip: `${CLEAN_SPOON} Store the tub upside down (lid on tight) to slow spoilage.` },
  tofu: {
    tip: 'Once opened, keep leftover tofu submerged in water in a sealed container and change the water daily. Freezing tofu (drained, in a bag) makes it chewier and extra good at soaking up sauce.',
    days: { fridge: 5, freezer: 120 },
    thaw: 'Thaw overnight in the fridge, then squeeze out the water — it will be spongy and absorb marinades.',
  },
  'refrigerated-tortellini': { tip: "Check the use-by date — unopened packs can go straight in the freezer and be cooked from frozen (add 1–2 minutes).", days: { freezer: 60 } },
  pesto: { tip: 'Press plastic wrap or pour a thin layer of olive oil onto the surface to stop it browning. Freeze extra in ice cube trays.', days: { freezer: 120 } },
  ...
  pita: { tip: BREAD_FREEZE, days: { freezer: 90 } },
  'brown-rice': { tip: 'Brown rice has oils that go rancid in a warm pantry — keep it airtight in the fridge or freezer if you use it slowly. Cooked rice freezes well in flat bags.', days: { fridge: 180 } },
  'whole-wheat-flour': { tip: 'Keep it in the fridge or freezer in an airtight container; it goes rancid in a few months at room temperature.', days: { freezer: 365 } },
  'chia-seeds': { tip: 'Store airtight somewhere cool and dark.' },
  almonds: { tip: 'Nuts go rancid in a warm pantry; keep open bags in the fridge or freezer.', days: { freezer: 365 } },
  pepitas: { tip: 'Keep open bags in the fridge or freezer so the oils stay fresh.', days: { freezer: 365 } },
  'peanut-butter': { tip: 'Natural peanut butter keeps longer (and doesn\'t separate as much) in the fridge.' },
  tahini: { tip: 'Refrigerate after opening. Stir well before using — the oil separates.' },
  miso: { tip: 'Keep it in the fridge with plastic pressed onto the surface; it lasts close to a year.' },
  'chipotle-adobo': { tip: 'Spoon leftover peppers with sauce into an ice cube tray or onto parchment in single-pepper dollops and freeze — no more wasted cans.', days: { freezer: 180 } },
  'green-chiles': { tip: 'Freeze leftover chiles in a small bag, flattened, and break off what you need.' },
  'enchilada-sauce': { tip: 'Leftover sauce keeps about 5 days in a jar in the fridge, or freeze it in a bag laid flat.' },
  'roasted-red-peppers': { tip: 'Keep the peppers covered in their liquid in the fridge after opening.' },
  'artichoke-hearts': { tip: 'Move leftovers with their liquid to a glass jar in the fridge; don\'t store in the open can.' },
