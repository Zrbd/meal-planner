...
- Cambodian chicken amok and Zambian ifisashi side added.
- Taiwanese lu rou fan and Liege waffles added; pearl sugar added to the catalog.
- Dominican pollo guisado and Lao larb gai added.
- Yemeni chicken mandi and Swiss rosti side added.
- Bangladeshi chicken bhuna and Guatemalan pepian de pollo added; pumpkin seeds and dried chiles added to the catalog.
...
- Five more soul food recipes: shrimp and grits, juicy baked chicken, fried okra,
  okra and tomatoes, and sock-it-to-me cake, from Grandbaby Cakes and Coop Can Cook.
  Added a `pecans` catalog entry and removed the now-duplicate 'pecans' aliases from
  almonds and walnuts.
...
- Added ten Latin American and Caribbean recipes in `src/data/recipes/latinAmerica.ts`: pollo saltado, causa limena, Cuban turkey picadillo, pernil, mofongo, coxinha, tostones, frijoles negros, pao de queijo and quindim (Peruvian, Cuban, Puerto Rican and Brazilian, each credited to a named developer).
...
- Added 13 Nordic, Low Countries and Alpine recipes (`nordicLowlands.ts`): frikadeller, waterzooi, stoemp,
  erwtensoep, geschnetzeltes, Konigsberger Klopse, two madtaerter, hasselbackspotatis (side), kaiserschmarrn,
  kanelsnegle, kardemummabullar and aebleskiver. New catalog ingredients: split peas, celery root.
- Added 13 South American recipes (`southAmerica.ts`): seco de pollo, arepas reina pepiada, feijoada,
  tallarines verdes, arroz chaufa, cachapas, chupe de camarones, papa a la huancaina (side), arroz con coco
  (side), farofa (side), suspiro limeno, pudim de leite and picarones. New catalog ingredient: cassava flour.
- Added thirteen South Asian regional recipes (`src/data/recipes/southAsia.ts`): Pakistani chicken karahi,
...
- Added thirteen Eastern European and Caucasian recipes (`src/data/recipes/easternEurope.ts`): satsivi, lobio,
  spinach pkhali, holubtsi, nalysnyky, lecso, toltott paprika, chakhokhbili, banitsa, Czech potato salad,
  mamaliga, papanasi and szarlotka. Four are sides, two desserts.
- SEED_VERSION 161.
